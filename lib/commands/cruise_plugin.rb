...
$verbose = false
PLUGINS_ROOT = CruiseControl::Configuration.plugins_root
...
class Repositories
  ...
  def initialize(cache_file = CruiseControl::Configuration.data_root.join("plugin_repositories.txt"))
  ...
  class List
    ...
    def parse!(args)
      ...
      if @remote
        ...
        cd CruiseControl::Configuration.plugins_root
